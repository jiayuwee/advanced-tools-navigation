...
async function checkGitHubActions() {
  try {
    ...
    console.log('   请访问: https://github.com/jiayuwee/advanced-tools-navigation/actions')
...
async function checkNetlify() {
  try {
    ...
    console.log('   请访问: https://app.netlify.com/sites/spiffy-torrone-5454e1/deploys')
...
async function runChecks() {
  ...
  console.log('📊 GitHub Actions: https://github.com/jiayuwee/advanced-tools-navigation/actions')
  console.log('📦 Netlify: https://app.netlify.com/sites/spiffy-torrone-5454e1/deploys')
  console.log('🗄️ Supabase: https://supabase.com/dashboard/project/ndmxwdejswybvbwrxsai')
