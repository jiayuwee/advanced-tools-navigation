...
console.log("\n🔗 相关链接:");
console.log(
  "- Netlify 环境变量设置: https://app.netlify.com/sites/[your-site]/settings/env",
);
console.log(
  "- GitHub Secrets 设置: https://github.com/jiayuwee/advanced-tools-navigation/settings/secrets/actions",
);
